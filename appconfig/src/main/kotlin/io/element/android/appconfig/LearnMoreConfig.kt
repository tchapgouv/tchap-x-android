...
object LearnMoreConfig {
    ...
    const val BACKUP_GUIDE_TCHAP_CLASSIQUE: String =
        "https://aide.tchap.numerique.gouv.fr/fr/article/verifier-la-sauvegarde-automatique-pour-la-connexion-depuis-tchap-classique-6zsiqk/"
    // :tchap: end
}
